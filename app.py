...
def predict():
    ...
    image_1 = face_recognition.load_image_file(r"C:\Users\Rushik\OneDrive\Documents\Desktop\attandance\dataset\NARENDRA\WhatsApp Image 2024-07-30 at 22.41.59_d3b1b536.jpg")
    image_1_face_encoding = face_recognition.face_encodings(image_1)[0]

    image_2 = face_recognition.load_image_file(r"C:\Users\Rushik\OneDrive\Documents\Desktop\attandance\dataset\RUSHIK\IMG-20231116-WA0016.jpg")
    image_2_face_encoding = face_recognition.face_encodings(image_2)[0]

    image_3 = face_recognition.load_image_file(r"C:\Users\Rushik\OneDrive\Documents\Desktop\attandance\dataset\ROHINI\IMG-20231117-WA0003.jpg")
    image_3_face_encoding = face_recognition.face_encodings(image_3)[0]

    image_4 = face_recognition.load_image_file(r"C:\Users\Rushik\OneDrive\Documents\Desktop\attandance\dataset\SAITEJA\WhatsApp Image 2024-07-30 at 22.37.20_31417db1.jpg")
...
def send_email():
    sender_email = "rushikbittu16@gmail.com"  
    receiver_email = "manasapanidapu@gmail.com"
    password = "zubt mays sgaa klpb"  
